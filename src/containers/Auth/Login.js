                    ...
                    <div className='login-content row'>
                        ...
                        <div className='col-12 form-group login-input'>
                            ...
                            <div className='custom-input-password'>
                                <input className='form-control' type={this.state.isShowPassword ? 'text' : 'password'} placeholder='Enter your password...' onChange={(event) => this.handleOnChangePassword(event)} />
